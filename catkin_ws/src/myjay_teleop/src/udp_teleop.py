...
if collect_data:
    vel_pub = rospy.Publisher("/undistorted/cmd_vel", Twist, queue_size =10)
else:   
    vel_pub = rospy.Publisher("/cmd_vel", Twist, queue_size =10)

training_vel_pub = rospy.Publisher("/user_cmd_vel", Twist, queue_size =10)
