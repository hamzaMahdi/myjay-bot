...
import time
config = {
  "apiKey": "AIzaSyDTMUWTiYHidhBv1pUT1yS2pxPEiyySoOA",
  "authDomain": "test-95a03.firebaseapp.com",
  "databaseURL": "https://test-95a03.firebaseio.com",
  "projectId": "test-95a03",
  "storageBucket": "test-95a03.appspot.com",
  "messagingSenderId": "185859652047",
  "appId": "1:185859652047:web:69ba42532e40f4ea667aba",
  "measurementId": "G-LVC358H22M"
}
...
while keepRunning:
    #for event in pygame.event.get():
            ...
            intake = int(base_line+joysticks[joy_index].get_button(8)*50)
            elevator = int(base_line+joysticks[joy_index].get_button(9)*50)
            ...
            db.child("users").child("Morty").update({"name": MESSAGE})
